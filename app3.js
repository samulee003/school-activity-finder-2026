function renderCompare(){
  ...
  if(!fav.length){
    el.favoritesPanel.innerHTML='<div class="compare-emptybar"><img src="'+IMAGE_MAP.cards+'" alt=""><div><strong>⭐ 收藏 0</strong><span>按星號加入比較</span></div></div>';
    return;
  }
